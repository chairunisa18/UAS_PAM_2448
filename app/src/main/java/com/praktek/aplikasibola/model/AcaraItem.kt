...
data class AcaraItem(
    ...
    annotation class Parcelize() : this(
    ...
    companion object CREATOR : Parcelable.Creator<AcaraItem> {
        override fun createFromParcel(parcel: Parcel): AcaraItem {
            return AcaraItem(parcel)
        }

        override fun newArray(size: Int): Array<AcaraItem?> {
